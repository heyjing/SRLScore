"""
Script to extract the VERB arguments
Requires PropBank to be available locally, and BeautifulSoup as a further dependency.
"""
...
def create_verb_lookup(file_names: List[str]):
    verbs_info = []
...
if __name__ == "__main__":
    ...
    # verbs_info = create_verb_lookup(["open.xml", "send.xml"])
    verbs_info = create_verb_lookup(all_files_and_folders)
