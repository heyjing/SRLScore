...
class StringSimilarityMethods:
    ...
    def calculate_string_similarity(self) -> float:
        methods = {
...
if __name__ == "__main__":
    # compare = StringSimilarityMethods("apple is good", "Apple good", "CER")
    # compare = StringSimilarityMethods("apple good", "apple is good", "CER")
    # compare = StringSimilarityMethods("a", None, "CER")
    # compare = StringSimilarityMethods(None, "a", "CER")
    # compare = StringSimilarityMethods(None, None, "CER")
    # compare = StringSimilarityMethods(None, None, "CER")
    # compare = StringSimilarityMethods("mueller", "robert mueller", "rouge")
    compare = StringSimilarityMethods("mueller", "robert mueller", "spacy")
    # compare = StringSimilarityMethods("creature", "alligator", "spacy")

    print(compare.calculate_string_similarity())
